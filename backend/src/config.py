...
class Config:
    ...
    def __init__(self, base_dir: Path | str | None = None) -> None:
        ...
        self.heartbeat_runs_dir = self.base_dir / "heartbeat_runs"
    ...
    def _ensure_dirs(self) -> None:
        for d in [
            ...
            self.heartbeats_dir, self.heartbeat_runs_dir, self.triggers_dir,
            self.skills_dir, self.tools_dir, self.data_dir, self.environments_dir,
        ]:
    ...
    def _default_settings(self) -> dict[str, Any]:
        return {
            ...
            "ui": {"leader_key": "\\", "leader_key_2": "", "theme_color": "zinc"},
            "logging": {"level": "INFO", "keep": 30},
            "heartbeat": {
                "enabled": False,
                "cron": "0 7 * * 1-5",
                "environment_id": None,
                "session_alias": "heartbeat",
                "heartbeat_prompt": "",
                "prompt": "",
            },
        }
    ...
    @property
    def defaults_dir(self) -> "Path | None":
        env = os.getenv("YAPFLOWS_DEFAULTS_DIR")

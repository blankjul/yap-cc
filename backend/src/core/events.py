...
class DividerEvent(BaseModel):
    """Signals a context boundary (result of /new or /compact command)."""
    type: Literal["divider"] = "divider"
    kind: Literal["new", "compact"]
...
PublicEvent = Union[
    ...
    InteractionRequestEvent, InteractionFormEvent, DividerEvent,
]

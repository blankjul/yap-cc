...
Tries the Strands built-in bash tool first; falls back to a custom
subprocess implementation if the built-in is unavailable.
"""
...
try:
    from strands.tools import bash as bash_tool  # type: ignore[attr-defined]

...
interface BlockListProps {
  message: ChatMessage;
  color: string;
  onChatAskSubmit?: (requestId: string, value: string) => void;
  timestamp?: string;
}
...
export function BlockList({ message, color, onChatAskSubmit, timestamp }: BlockListProps) {
          ...
          if (block.type === "text") {
            return (
              <TextSegment
                ...
                color={color}
                timestamp={isLast && message.done ? timestamp : undefined}
              />
            );
          }
            ...
            return (
              <ChatAskWidget
                ...
                onSubmit={(requestId, value) =>
                  onChatAskSubmit?.(requestId, value)
                }
              />
            );
          }

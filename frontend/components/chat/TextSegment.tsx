...
export function TextSegment({ content, showCursor, color, timestamp }: TextSegmentProps) {
  return (
    <div className="group/seg relative">
      ...
      {!showCursor && (
        <>
          ...
          {timestamp && (
            <div className="opacity-0 group-hover/seg:opacity-100 transition-opacity mt-1 pl-1">

  ...
  return (
    <div className={`rounded-lg border text-xs font-mono transition-colors ${containerClass}`}>
      ...
      >
        ...
        {count === 1 && toolCalls[0].inputSummary && (
          <span className="text-zinc-500 dark:text-zinc-400 truncate max-w-[40ch]">
              ...
              <div key={idx} className="pt-2 space-y-2.5">
                ...
                {hasArgs && (
                  <div>
                    ...
                    <pre className="text-[11px] text-zinc-700 dark:text-zinc-300 bg-black/5 dark:bg-zinc-950/60 rounded-md px-2.5 py-2 overflow-x-auto whitespace-pre-wrap break-all leading-relaxed">
                ...
                {hasResult && (
                  <div>
                    ...
                    <pre
                      className={`text-[11px] rounded-md px-2.5 py-2 overflow-auto whitespace-pre-wrap break-all leading-relaxed ${outputClass}`}
                    >
